...
INSERT INTO station (id, position, name, time_arrival, time_departure) VALUES (12, 2, 'Brest', '08:40', NULL);
INSERT INTO station (id, position, name, time_arrival, time_departure) VALUES (13, 1, 'Brest', NULL, '17:15:00');
INSERT INTO station (id, position, name, time_arrival, time_departure) VALUES (14, 2, 'Grodno', '05:50', NULL);
...
/*
INSERT INTO single_route (id, from_st, to_st, distance) VALUES

  (1, 'Vitebsk', 'Minsk', 293.7),
  (2, 'Minsk', 'Vitebsk', 293.7),
  (3, 'Vitebsk', 'Mogilev', 157.6),
  (4, 'Mogilev', 'Gomel', 245.1),
  (5, 'Gomel', 'Mogilev', 245.1),
  (6, 'Mogilev', 'Vitebsk', 157.6),
  (7, 'Grodno', 'Brest', 590.3),
  (8, 'Brest', 'Grodno', 590.3),
  (9, 'Vitebsk', 'Mogilev', 157.6),
  (10, 'Mogilev', 'Gomel', 245.1),
  (11, 'Gomel', 'Brest', 531.3),
  (12, 'Brest', 'Gomel', 531.3),
  (13, 'Gomel', 'Mogilev', 245.1),
  (14, 'Mogilev', 'Vitebsk', 157.6),
  (15, 'Minsk', 'Brest', 348.4),
  (16, 'Brest', 'Minsk', 348.4);
*/
